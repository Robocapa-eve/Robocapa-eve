...
Designed for pilots who want relevant information immediately available without unnecessary clutter, SENTINEL combines live intelligence, live kill activity, live character monitoring and tactical map data in a focused Windows environment.
...
`Reliability` · `Clarity` · `Performance` · `Operational Awareness`

Public releases and documentation will become available as SENTINEL approaches public testing.
